# BOBPE Website Content Checklist

This checklist tracks the repositories, links, and supporting materials needed to fully populate the BOBPE website project blurbs.
...
- [ ] Notes on instructor control and constraints
...
### BUFFALO
- [ ] Project description
- [ ] Grant or proposal abstract
- [ ] Related GitHub repositories
- [ ] Classroom or research deployment notes

---

### POLLENATORS
- [ ] Framework description
- [ ] Institutional or organizational examples
- [ ] Related materials or talks
- [ ] Status (concept / active / ongoing)
...
- [ ] Hero image selected
- [ ] Section placeholder images selected
- [ ] Alt text written for all images
- [ ] GitHub links validated
- [ ] Copy reviewed for clarity and tone
- [ ] Google Sites layout updated
- [ ] Repo README synced with live site

---

## NOTES
- [ ] Items intentionally excluded documented
- [ ] Future projects flagged as “in progress”
- [ ] Final pass for consistency with BOBPE framing
