...
The repository is organized to support both human-readable website content and future programmatic use (e.g., static site generation, content reuse, or AI-assisted workflows).
...
- `homepage.md` – Main landing page content for the BOBPE website  
- `mission.md` – Canonical mission statement and philosophical framing  
- `projects/` – Individual project pages and supporting artifacts  

---

## Website Content

### Homepage and Mission

- **Homepage**  
  `website/content/homepage.md`

- **BOBPE Mission**  
  `website/content/mission.md`
...
Project pages are stored in subdirectories under:
...
- A primary `.md` file used for the website
...
The following directories are included for continuity and future expansion, but are **not currently surfaced** on the public website:

- `projects/buffalo/`
- `projects/pollenators/`
- `projects/charge/`
...
- Markdown files in `website/content/` are the **canonical source of truth** for website copy.
- PDFs, images, and raw READMEs are included for reference and provenance.
- The structure is designed to support:
  - Manual copy/paste into Google Sites
  - Future static site generation
  - Programmatic content extraction or AI-assisted reuse
