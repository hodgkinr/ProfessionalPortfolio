...
1. Students complete a concept inventory question with a written explanation.
2. The bot reviews the response and initiates a Socratic dialogue.
3. Students respond to follow-up prompts that challenge assumptions or clarify reasoning.
4. Where appropriate, students are guided toward curated learning resources.
5. Students leave with a clearer understanding of both correct concepts and misconceptions.
